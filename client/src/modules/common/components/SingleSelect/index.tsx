...
const SingleSelect: React.FC<ISingleSelect> = ({ items, data, label, onChange, className = "" }) => {
	...
	return (
		<div className={`${styles.root} ${className} relative`} {...getComboboxProps()}>
			...
			<ul className={isOpen ? "absolute gap-2 flex-wrap flex rounded p-2  bg-white" : ""} {...getMenuProps()}>
				{isOpen &&
